...
document.addEventListener('DOMContentLoaded', function() {
    ...
    Highcharts.chart(topKeywordCHart, {
        ...
        xAxis: {
            categories: {
                !!json_encode($top_keywords - > pluck('search_phrase')) !!
            }
        },
        yAxis: {
            title: {
        ...
        series: [{
            ...
            data: {
                !!json_encode($top_keywords - > pluck('count')) !!
            }
        }]
    ...
    Highcharts.chart(topDashboardCHart, {
        ...
        xAxis: {
            categories: {
                !!json_encode($top_dashboards - > pluck('item.title')) !!
            }
        },
        credits: {
            enabled: false
        ...
        series: [{
            name: 'Number of Searches',
            data: {
                !!json_encode($top_dashboards - > pluck('count')) !!
            }
        }]
