                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{@$item->title}}" name="title" class="form-control"
                                placeholder="{{__('cms.title')}}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="description" class="form-control"
                                placeholder="{{__('cms.description')}}">{{@$item->description}}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="url" value="{{@$item->url_link}}" class="form-control"
                                placeholder="{{__('cms.link')}}" required>
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>{{__('cms.image')}} (The image should contain landing page) </label>
                            <input type="file" name="image" class="form-control" placeholder="{{__('cms.image')}}"
                                required>
                        </div>
                        <div class="form-group">
                            <label>{{__('cms.db_engine')}}</label>
                            <input type="text" name="db_engine" value="{{@$item->db_engine}}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-2" placeholder="Submitting Phone Number"
                                name="submitter_phone" class="form-group mb-2" required />
                            <input type="text" class="form-control" name="submitter_email"
                                placeholder="Submitting Email" class="form-group mb-2" />
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div id="contact" style="max-height: 600px; overflow:auto;">
                                    ...
                                    <input type="button" value="Add More Contact Persons" class="btn btn-primary  mb-2"
                                        onclick="addContact()">
                                    ...
                                    <input type="text" class="form-control mb-2" placeholder="Phone Number"
                                        name="phone[]" class="form-group mb-2" required />
                                    <input type="text" class="form-control" name="email[]" placeholder="Email"
                                        class="form-group mb-2" required />
                                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group btn-wrapper">
                            <br>
                            <input type="submit"
                                class="btn btn-primary d-block w-100 d-flex align-items-center justify-content-center p-2"
                                value="Submit">
                        </div>
                    </div>
                </div>
...
function addContact() {
    ...
    contact_row +=
        '<input type="button" value="Remove Contact Person" class="btn btn-primary   btn-sm  mb-2"  onclick="removeContact($(this))" ></div>'
