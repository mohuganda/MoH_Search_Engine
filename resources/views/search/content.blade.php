            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 d-flex align-items-stretch aos-init aos-animate" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                    <div class="listing-wrap">
                        ...
                        <div class="text text-center">
                            <div class="d-flex justify-content-left search-text">
                                <a href="{{url('search')}}">Reproductive and Maternal Child Health Training Dashboard</a>
                            </div>
                            <div class="d-flex justify-content-left description ">
                ...
                <div class="col-md-12 col-lg-12 d-flex align-items-stretch aos-init aos-animate" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                    <div class="listing-wrap">
                        ...
                        <div class="text text-center">
                            <div class="d-flex justify-content-left search-text">
                                <a href="{{url('search')}}">Performance Management</a>
                            </div>
                            <div class="d-flex justify-content-left description ">
                            ...
                            <div class="info-wrap2 align-items-center description">
                                <p class="review"><span class="rev">Access Method: <small>Valid username and Password</small></span>
                                <p class="review"><span class="rev">Category: <small>General Administration</small></span> 
