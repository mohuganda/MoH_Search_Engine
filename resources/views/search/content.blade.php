<div class="container">
    <div class="row">
        ...
        <div class="col-md-9 offset-2">
            <p class="mt-4" style="color:#000; font-weight:bold;">{{ $results->total() }} results in
                {{ number_format((microtime(true) - LARAVEL_START)*10,1) }} seconds</p>
            ...
            <section class="ftco-section ftco-no-pt">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-12 d-flex align-items-stretch aos-init aos-animate" data-aos="fade-up"
                        ...
                        <div class="listing-wrap">
                            ...
                            <div class="text text-center">
                                <div class="d-flex justify-content-left search-text">
                                    ...
                                    @if(is_valid_image($result->image))
                                ...
                                <div class="d-flex justify-content-left description"
                                    style="clear:both; text-align:left; margin-right:6px; margin-top:10px;">
                                ...
                                <div class="info-wrap2 align-items-center description">
                                    ...
                                    <p class="review text-truncate">
                                        <span class="rev"><small>
                                                <a href="{{ $result->url_link }}" target="_blank">Navigate
                                                    {{ ucwords($result->title) }}</a></small>
                                        </span>
                                    </p>
                                    ...
                                    <p class="review"><span class="rev">Theme:
                                        ...
                                        <span class="rev">Type:
                                            <small>{{ $result->item_type->item_type_name }}</small></span> |
                                        <span class="rev">Access: <small>{{ $result->access_method }}</small></span> |

                                        @if($result->access_method == 'Restricted')
                                        <span class="rev"><small>
                                                <a href="{{ url('/access',$result->id) }}" target="_blank">{{
                                                    __('general.request_access')}}</a></small>
                                        </span> |
                                        @endif
                                        <span class="rev"><small>
                                                <a href="{{ url('/iteminfo',$result->id) }}" target="_blank">{{
                                                    __('general.moreinfo')}}</a></small>
                                        </span>
                                    </p>
                                </div>
                            </div>
